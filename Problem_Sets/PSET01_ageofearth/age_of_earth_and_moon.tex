...
% --- Make section headings bold + sans-serif (including starred sections) ---
\usepackage{titlesec}
...
Despite the discovery of radioactivity in the early 20th century  and immediate effort to date Earth materials using radioactive decay, it took more than 50 years until isotope geochemists were able to produce an age for Earth that was close to what we use today. \citet{patterson1956age} is commonly cited as the first correct determination of the age of the earth.

\begin{marginfigure}
  \includegraphics[width = 2.5in]{clair_patterson.png}
%  \checkparity This is an \pageparity\ page.%
  \caption[Canyon Diablo Meteorite]{Clair Patterson (1922--1995) was an American geochemist known for determining the age of the Earth using Pb--Pb isotope geochemistry of meteorites and for advocating for the removal of lead from gasoline.  }
  \label{fig:patterson}
  %\zsavepos{pos:textfig} 
\end{marginfigure}


Patterson's approach was based on a key idea from the \textit{Nebular Hypothesis}: that our solar system formed from the collapse of an interstellar solar nebula---a giant cloud of gas a dust. From this hypothesis, several important assumptions follow: 

\begin{quote}
\begin{compactenum}
  \item meteorites and earth formed at essentially the same time from the solar nebula, 
...
\begin{marginfigure}
  \includegraphics[width = 2.5in]{canyon_diablo4.jpg}
%  \checkparity This is an \pageparity\ page.%
...
The pre-lab assignment is to get VSCode, Python, and Jupyter notebooks set up on your computer. Please follow the instructions here: \href{https://github.com/boltonhowes22/EarthHistory/blob/main/Guides/python_install.pdf}{Python Install Guide}. 

\vspace*{.175in}

\noindent Then try download and run the this notebook: \href{https://github.com/boltonhowes22/EarthHistory/blob/main/Problem_Sets/PSET01_ageofearth/isochron_demo.ipynb}{Isochron Demo} \sidenote{please let me know if you have any issues getting this to run!}.

\subsection*{Pre-Lab Part 2: The Warm-Up}
\begin{compactenum}
  ...
  \item Why do we normalize daughter and parent to a stable isotope (e.g.,$ ^{204}\mathrm{Pb}$)? Hint: Read about Clair Patterson's work on leaded gasoline. 
...
\section*{The Lab}
\subsection*{Part 1: Pb-Pb Isochron Age of the Earth}
\begin{compactenum}
...
\subsection*{Part 2: Rb-Sr Age of the Moon}
\begin{compactenum}
...
\subsection*{Part 3: The U-Pb age of Moon (not an isochron)}
\begin{compactenum}
