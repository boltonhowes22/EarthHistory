...
%%
% Book metadata
\title{Earth History\\ \&  Stratigraphy}
\author[Bolton]{Bolton Howes}
\publisher{}
...
}{Winston Churchill%, {\itshape Design, Form, and Chaos}
}
\vfill
\openepigraph{%
The stratigraphic record is a lot of holes tied together with sediment.
}{Derek Ager}
\vfill
\openepigraph{%
...
\newthought{In 1958}, in 1958 scientists began making the first continuous measurements of CO2 in the atmosphere on the top of a volcano in Hawaii. Charles David Keeling, the project leader, chose this location because its high altitude and isolation limited the contamination. In 1960, Keeling published the first results from this study and made two very imporant observations: 
\vspace*{.1in}
\begin{compactenum}
  \item The amount of CO2 in the atmosphere rises in the winter and falls in the summer. \sidenote{This fall in CO2 during the northern hemisphere summer was determined to be the result of the growing of vegetation since the northern hemisphere has more land mass.} 
  \item The amount of CO2 in the atmosphere seems to be increasing each year. 
\end{compactenum}
\vspace*{.1in}

\noindent The first observation is interesting, but the second observation, that CO2 was potentially increasing, would go on to change the course of the 20th Century. At the time though, Keeling could not be certain CO2 was increasing because there was not enough data and scientists did not know what CO2 concentrations had been in the past---is CO2 lower or higher than it was 100 years ago? what about 200 years ago?. \sidenote{There were other scientist that had suggested the combustion of fossil fuels \emph{could} raise CO2, but nobody had measured it.} But thankfully, scientists (led by Charles David Keeling's son, Richard) have continued to make these measurements atop the remote volcano and a rather clear picture has developed (Figure \ref{fig:keeling-curve}). 

\begin{marginfigure}
  \includegraphics{keeling_curve.pdf}
%  \checkparity This is an \pageparity\ page.%
  \caption[The Keeling Curve]{The Keeling Curve with all data collected since the program began. There has been a steady increase in the concentration of from an annual mean below 320 ppm in 1958 to now above 420 ppm. In the inset, the seasonal variability of CO2 --- as plants bloom in the northern hemisphere spring, the CO2 starts to come down from its annual peak in May.}
  \label{fig:keeling-curve}
  %\zsavepos{pos:textfig}
\end{marginfigure}


\section{How does CO2 actually warm the planet?}


%This sample book discusses the design of Edward Tufte'sbooks\cite{Tufte2001,Tufte1990,Tufte1997,Tufte2006} classes.
...
\chapter*{Origin of the Solar System}
\label{solar_system}

\chapter{The Age of the Earth and Moon}
\label{ch:age_of_earth}

Despite the discovery of radioactivity in the early 20th century [citation] and immediate effort to date Earth materials using radioactive decay [cite], it took more than 50 years until isotope geochemists were able to produce an age for Earth that was close to what we use today. \citet{patterson1956age} is commonly cited as the first correct determination of the age of the earth.
...
\begin{docspec}
\begin{compactenum}
  \item meteorites and earth formed at the same time, 
...
In other words, if the solar system originated from one geochemically homogeneous cloud, then meteorites preserve a record of its initial composition and provide a direct reference for dating the Earth.

\begin{marginfigure}
  \includegraphics{clair_patterson.png}
%  \checkparity This is an \pageparity\ page.%
...
\begin{marginfigure}
  \includegraphics{canyon_diablo4.jpg}
%  \checkparity This is an \pageparity\ page.%
  \caption[Canyon Diablo Meteorite]{The Canyon Diablo meteorite is one of the samples that was used by Clair Patterson in his attempt to determine the age of the Earth. The Canyon Diablo impactor struck Arizona roughly 50k years ago and left a crater that is roughly 1.2 km wide and 180 m deep.  }
  \label{fig:canyon_diablo}
  %\zsavepos{pos:textfig}
...
same time but contained different amounts of U, the data fall along a single 
line---a ``concordia'' trajectory. The slope of this line encodes the age of the 
...
\begin{compactenum}
  \item What are the key assumptions of using an isochron to determine the age of a sample?
  \item Why do we normalize daughter and parent to a sable isotope (e.g.,$ ^{204}\mathrm{Pb}$)?
...
Please look through the step-by-step example I give of how to write the code for estimating the age of the earth using the isochron method. %\href{}{Click here for an example}

\subsection*{Part 2: The Age of the Earth}
\begin{compactenum}
