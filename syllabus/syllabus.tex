...
% Booktabs for prettier tables
\usepackage{booktabs}
% Multirow if you want the "Week" label to span the three rows
\usepackage{multirow}
% If you need text wrapping in columns, you can also use array or tabularx
\usepackage{array}
\usepackage{tabularx}
...
% COURSE DESCRIPTION
  ...
  \vspace{2ex} \hrule\vspace{0ex}
 
% ----------------------------------------------------- %
% LEARNING OUTCOMES
  \subsection*{And His Kingdom}
  \input{\local/andhiskingdom}
