...
\newcommand{\officehours}{W 10:00--12:00\,a.m., F 10:00\,a.m--1:00\,p.m., \& by appointment}
...
Each Lab is due at 5 pm on the Monday following the lab in which we worked on it unless otherwise noted. 
...
\begin{itemize}
    \item Give a brief overview of the paper (7--10 minutes): the main question, why it matters, and the key results. (I will help and the other students will also help. You are not on your own here.)
...
As the audience, your job is to:
\begin{itemize}
    \item Ask questions when you are confused. Or would like to know more. 
    \item Help out the presenter if they get stuck.
    \item Point out any interesting points or implications that the presenter did not mention.
\end{itemize}
...
There will be short quizzes at the beginning of class on some days. These quizzes will be based on the readings and discussions from previous classes. They should be straightforward if you have been keeping up with the readings and participating in class. I do not expect these quizzes to be stressful, they are just  a way for me and you to check in and make sure you are keeping up with the material.
